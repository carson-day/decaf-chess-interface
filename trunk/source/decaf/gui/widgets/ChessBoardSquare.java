...
public class ChessBoardSquare extends JPanel // implements MouseListener,
	...
	private static class MyDragSourceMotionListener implements
			DragSourceMotionListener {

		public void dragMouseMoved(DragSourceDragEvent arg0) {

			if (squareDragStartedIn != null
					&& squareDragStartedIn.getPreferences()
							.getBoardPreferences()
							.isSelectingHoverOverSquares()
					&& squareDragStartedIn.getParent() instanceof ChessBoard
					&& squareDragStartedIn.getPreferences()
							.getBoardPreferences().getDragAndDropMode() != BoardPreferences.INVISIBLE_MOVE) {
