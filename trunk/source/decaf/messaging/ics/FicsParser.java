...
import decaf.messaging.ics.nongameparser.BugClosedEventParser;
import decaf.messaging.ics.nongameparser.BugOpenEventParser;
import decaf.messaging.ics.nongameparser.BugWhoGEventParser;
import decaf.messaging.ics.nongameparser.BugWhoPEventParser;
import decaf.messaging.ics.nongameparser.BugWhoUEventParser;
import decaf.messaging.ics.nongameparser.CShoutEventParser;
...
import decaf.messaging.ics.nongameparser.ShoutEventParser;
import decaf.messaging.ics.nongameparser.SoughtEventParser;
import decaf.messaging.ics.nongameparser.TellEventParser;
import decaf.messaging.ics.nongameparser.WhisperEventParser;
...
public class FicsParser {
	...
	List<NonGameEventParser> nonGameEventParsers = new ArrayList<NonGameEventParser>(
			30);

	private int icsId;

	public FicsParser(int icsId) {
		this.icsId = icsId;
		...
		nonGameEventParsers.add(new SoughtEventParser(icsId));
		nonGameEventParsers.add(new ChannelTellEventParser(icsId));
		nonGameEventParsers.add(new ClosedEventParser(icsId));
		nonGameEventParsers.add(new CShoutEventParser(icsId));
		nonGameEventParsers.add(new ShoutEventParser(icsId));
		nonGameEventParsers.add(new KibitzEventParser(icsId));
		nonGameEventParsers.add(new NotificationEventParser(icsId));
		nonGameEventParsers.add(new OpenEventParser(icsId));
		nonGameEventParsers.add(new PartnerTellEventParser(icsId));
		nonGameEventParsers.add(new TellEventParser(icsId));
		nonGameEventParsers.add(new WhisperEventParser(icsId));

		// Non tell types of events.
		nonGameEventParsers.add(new MoveListParser(icsId));
		nonGameEventParsers.add(new BugClosedEventParser(icsId));
		nonGameEventParsers.add(new BugOpenEventParser(icsId));
