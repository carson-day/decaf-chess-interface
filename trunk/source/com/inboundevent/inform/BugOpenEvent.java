...
public class BugOpenEvent extends InboundEvent {
	public BugOpenEvent(Object source, String messageId, String text) {
		super(source, messageId, text);
	}

	public String toString() {
		return "<BugOpenEvent>" + super.toString() + "</BugOpenEvent>";
	}
}