...
public class KibitzEventParser extends InboundEventParser {
	public KibitzEventParser(Object source) {
			...
			if (stringtokenizer.hasMoreTokens()) {
				...
				if (stringtokenizer.hasMoreTokens()) {
					...
					if (s2.equals("kibitzes:")) {
						...
						int k = text.indexOf("]");
						try {
							return new KibitzEvent(getSource(), "" + id++,
									text, text.substring(i
											+ "kibitzes:".length()), ParserUtil
											.removeTitles(s1), Integer
	...
	private static final String IDENTIFIER = "kibitzes:";
