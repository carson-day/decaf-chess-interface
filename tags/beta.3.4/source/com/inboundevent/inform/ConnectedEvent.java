...
public class ConnectedEvent extends InboundEvent {

	public ConnectedEvent(Object source, String messageId, String text,
	...
	public String toString() {
		return "<ConnectedEvent>" + super.toString() + "<user>" + user
