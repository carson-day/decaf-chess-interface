...
public class AsciiPositionEncoder implements PositionEncoder {
	private static final LongAlgebraicEncoder LONG_ALGEBRAIC_ENCODER = new LongAlgebraicEncoder();
	...
	public String encode(int piece) {
		...
		switch (piece) {
		case decaf.gui.util.PieceUtil.EMPTY: {
			return " ";
		}

		case decaf.gui.util.PieceUtil.WP: {
			return "P";
		}

		case decaf.gui.util.PieceUtil.BP: {
			return "p";
		}
		case decaf.gui.util.PieceUtil.WN: {
			return "N";
		}
		case decaf.gui.util.PieceUtil.BN: {
			return "n";
		}
		case decaf.gui.util.PieceUtil.WB: {
			return "B";
		}
		case decaf.gui.util.PieceUtil.BB: {
			return "b";
		}
		case decaf.gui.util.PieceUtil.WR: {
			return "R";
		}
		case decaf.gui.util.PieceUtil.BR: {
			return "r";
		}
		case decaf.gui.util.PieceUtil.WQ: {
			return "Q";
		}
		case decaf.gui.util.PieceUtil.BQ: {
			return "q";
		}
		case decaf.gui.util.PieceUtil.WK: {
			return "K";
		}
		case decaf.gui.util.PieceUtil.BK: {
			return "k";
		}
		}
